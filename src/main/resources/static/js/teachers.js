...
document.getElementById('searchForm').addEventListener('submit', function() {
	...
	document.getElementById('idLink').href = '/teachers/' + (searchValue || 0) + '/findById';
	document.getElementById('loginLink').href = '/teachers/' + (searchValue || " ") + '/findByLogin';
	document.getElementById('passportLink').href = '/teachers/' + (searchValue || " ") + '/findByPassportNumber';
	document.getElementById('telephoneLink').href = '/teachers/' + (searchValue || " ") + '/findByTelephoneNumber';
	document.getElementById('nameLink').href = '/teachers/' + (searchValue || " ") + '/findAllByName';
	document.getElementById('courseNameLink').href = '/teachers/' + (searchValue || " ") + '/findByCourseName';
	document.getElementById('courseIdLink').href = '/teachers/' + (searchValue || " ") + '/findByCourseId';
	document.getElementById('lessonIdLink').href = '/teachers/' + (searchValue || " ") + '/findByLessonId';
