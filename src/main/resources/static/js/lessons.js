...
document.getElementById('searchForm').addEventListener('submit', function() {
	...
	document.getElementById('idLink').href = '/lessons/' + (searchValue || 0) + '/findById';
	document.getElementById('lessonDateLink').href = '/lessons/' + (searchValue || " ") + '/findAllByLessonDate';
	document.getElementById('courseIdLink').href = '/lessons/' + (searchValue || " ") + '/findAllByCourseId';
	document.getElementById('courseNameLink').href = '/lessons/' + (searchValue || " ") + '/findAllByCourseName ';
	document.getElementById('roomIdLink').href = '/lessons/' + (searchValue || " ") + '/findAllByRoomId';
