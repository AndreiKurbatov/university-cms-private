...
document.getElementById('searchForm').addEventListener('submit', function() {
	...
	document.getElementById('idLink').href = '/groups/' + (searchValue || 0) + '/findById';
	document.getElementById('groupNameLink').href = '/groups/' + (searchValue || " ") + '/findByGroupName';
	document.getElementById('specializationLink').href = '/groups/' + (searchValue || " ") + '/findAllBySpecialization';
	document.getElementById('studentAmountLink').href = '/groups/' + (searchValue || " ") + '/findAllWithLessOrEqualStudents';
