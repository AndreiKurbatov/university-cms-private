...
document.getElementById('searchForm').addEventListener('submit', function() {
	...
	document.getElementById('idLink').href = '/administrators/' + (searchValue || 0) + '/findById';
	document.getElementById('loginLink').href = '/administrators/' + (searchValue || " ") + '/findByLogin';
	document.getElementById('passportLink').href = '/administrators/' + (searchValue || " ") + '/findByPassportNumber';
	document.getElementById('telephoneLink').href = '/administrators/' + (searchValue || " ") + '/findByTelephoneNumber ';
	document.getElementById('nameLink').href = '/administrators/' + (searchValue || " ") + '/findByName';
